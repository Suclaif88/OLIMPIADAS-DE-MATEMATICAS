...
def abrir_ventana_juego(grado):
    ...
    imagen_fondo_juego = Image.open('fondo_juego.png')  # Reemplaza 'fondo_juego.png' con la ruta de tu imagen de fondo para el juego
...
imagen_fondo_inicio = Image.open('fondo_inicio.png')  # Reemplaza 'fondo_inicio.png' con la ruta de tu imagen de fondo para la ventana de inicio
