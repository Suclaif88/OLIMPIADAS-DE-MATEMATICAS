...
def cerrar_imagen_actual():
    ...
    if imagen_pregunta_actual:
        pregunta_label_imagen.config(image=None)  # Limpiar la imagen actual
...
def mostrar_pregunta():
    ...
    if pregunta_tipo == 'imagen':
        ...
        pregunta_label_imagen.config(image=imagen_pregunta_actual, text=nombre_imagen)
        pregunta_label_imagen.image = imagen_pregunta_actual
        pregunta_label_imagen.pack()  # Mostrar el widget de la imagen
    else:
        pregunta_label_imagen.config(image=None, text='')  # Limpiar cualquier imagen o texto previo
