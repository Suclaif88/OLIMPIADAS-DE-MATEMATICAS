...
pregunta_texto = tk.StringVar()  # Variable para mostrar la pregunta actual
...
def mostrar_pregunta():
    ...
    # Borrar la imagen de la pregunta anterior
    pregunta_label.config(image=None)
    ...
    elif pregunta_actual['tipo'] == 'imagen':
