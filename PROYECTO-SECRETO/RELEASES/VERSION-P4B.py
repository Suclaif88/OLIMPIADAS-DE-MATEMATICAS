...
# Variable para mantener la imagen actual
...
def mostrar_pregunta():
    ...
    if not preguntas_disponibles:
        ...
        pregunta_label_texto.config(text='')  # Limpiar cualquier texto previo
    ...
    if pregunta_tipo == 'imagen':
        if imagen_pregunta_actual:
            imagen_pregunta_actual.close()  # Cierra la imagen anterior
