...
def abrir_ventana_juego(grado):
    ...
    def mostrar_imagen_respuesta(imagen_respuesta):
        ...
        ventana_juego.after(2000, ocultar_imagen_respuesta)  # Ocultar la imagen después de 2 segundos
    ...
    imagen_fondo_juego = Image.open('IMG/fondo_juego.png')  # Reemplaza 'fondo_juego.png' con la ruta de tu imagen de fondo para el juego
    ...
    imagen_respuesta_correcta = Image.open('bien.png')
    imagen_respuesta_correcta = ImageTk.PhotoImage(imagen_respuesta_correcta)
    imagen_respuesta_incorrecta = Image.open('mal.png')
...
oli_titulo = tk.Label(ventana_inicio, text='OLIMPIADAS DE MATEMATICAS', bg="black", fg="white", pady=20, font=('bold', 50))
oli_titulo.pack(pady=10)


etiqueta_grado = tk.Label(ventana_inicio, text='Selecciona el grado:', bg="black", fg="white", pady=20, font=('bold', 50))
etiqueta_grado.pack(pady=10)

boton_grado_9 = tk.Button(ventana_inicio, text='Grado 9°', bg="black", fg="white", font=('arial', 25), width=18, height=3, pady=3, command=lambda: abrir_ventana_juego(9))
boton_grado_9.pack(pady=15)

boton_grado_10 = tk.Button(ventana_inicio, text='Grado 10°', bg="black", fg="white", font=('arial', 25), width=18, height=3, command=lambda: abrir_ventana_juego(10))
boton_grado_10.pack(pady=15)

boton_grado_11 = tk.Button(ventana_inicio, text='Grado 11°', bg="black", fg="white", font=('arial', 25), width=18, height=3,  command=lambda: abrir_ventana_juego(11))
