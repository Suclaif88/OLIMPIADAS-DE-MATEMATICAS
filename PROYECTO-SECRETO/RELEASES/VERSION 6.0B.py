...
def abrir_ventana_juego(grado):
    global preguntas_disponibles, pregunta_actual, imagen_pregunta_actual, imagen_respuesta_correcta, imagen_respuesta_incorrecta, puntaje_actual, chao
    ...
    # Cerrar la ventana emergente después de 2 segundos
     resultado_ventana.after(2000, resultado_ventana.destroy)
    ...
    def chao():
     ...
     ventana_inicio.after(2000, ventana_inicio.destroy)
    ...
    imagen_fondo_juego = Image.open('IMG/fondo_juego.png')  # Ruta de la imagen de fondo
    ...
    imagen_respuesta_correcta = Image.open('IMG/bien.png')  # Ruta de la imagen de respuesta correcta
    imagen_respuesta_correcta = ImageTk.PhotoImage(imagen_respuesta_correcta)
    imagen_respuesta_incorrecta = Image.open('IMG/mal.png')  # Ruta de la imagen de respuesta incorrecta
...
terminar_boton = tk.Button(ventana_inicio, text='CERRAR JUEGO', font=('Arial', 12),  bg='red', width=40,  command=lambda: chao())
terminar_boton.pack(pady=10)
