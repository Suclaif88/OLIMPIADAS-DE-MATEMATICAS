...
def abrir_ventana_juego(grado):
    ...
    def mostrar_pregunta():
      ...
      if preguntas_disponibles:
        ...
        pregunta_imagen.pack_forget()  # Oculta la imagen antes de mostrarla de nuevo

        if pregunta_actual['tipo'] == 'imagen':
            texto_debajo_imagen.config(text='')  # Limpia el texto debajo de la imagen
