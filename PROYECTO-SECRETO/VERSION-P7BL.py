...
imagen_fondo = tk.PhotoImage(file='fondo_inicio.png')  # Reemplaza 'tu_imagen_de_fondo.png' con la ruta de tu imagen

# Configurar la imagen de fondo en la ventana principal
...
for i in range(4):
    boton = tk.Button(
        ...
        text='',
        font=('Arial', 12),
        command=lambda i=i: verificar_respuesta(pregunta_actual['opciones'][i]),
        borderwidth=7,
        width=40,
        bg='salmon',
        highlightbackground='blue'
    )
    boton.grid(row=i // 2, column=i % 2, padx=10)
...
siguiente_boton = tk.Button(ventana, text='Siguiente', font=('Arial', 12), bg='lightblue', width=40, command=mostrar_pregunta)
