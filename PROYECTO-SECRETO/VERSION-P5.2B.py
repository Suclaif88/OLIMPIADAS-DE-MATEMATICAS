...
preguntas = [
    ...
    {
        'tipo': 'imagen',
        'nombre_imagen': 'Título personalizado',  # Título que deseas mostrar
...
pregunta_label_imagen = tk.Canvas(ventana, width=400, height=300)
pregunta_label_imagen.pack(pady=10)

def cerrar_imagen_actual():
    global imagen_pregunta_actual
    if imagen_pregunta_actual:
        pregunta_label_imagen.delete("all")  # Limpiar el canvas de la imagen
...
def mostrar_pregunta():
    ...
    if pregunta_tipo == 'imagen':
        ...
        pregunta_label_imagen.create_image(0, 0, anchor="nw", image=imagen_pregunta_actual)
        pregunta_label_imagen.create_text(200, 150, text=nombre_imagen, font=('Arial', 14))
        pregunta_label_imagen.pack()  # Mostrar el canvas de la imagen
    else:
        pregunta_label_imagen.delete("all")  # Limpiar cualquier imagen o texto previo
