...
preguntas = [
    ...
    'opciones': ['RECURSOS/opcion1.png', 'RECURSOS/opcion2.png', 'RECURSOS/opcion3.png', 'RECURSOS/opcion4.png'],  # Rutas de imágenes como opciones de respuesta
    'respuesta_correcta': 'RECURSOS/opcion2.png'  # Ruta de la imagen de la respuesta correcta
    },
    {
        'grado': 9,
        'tipo': 'imagen',
...
def abrir_ventana_juego(grado):
    ...
    def mostrar_pregunta():
     ...
     if preguntas_disponibles:
        ...
        # Elimina las imágenes de los botones y redimensiona los botones a su tamaño predeterminado
        for boton in botones_opciones:
            boton.config(text="", image=None, compound="center", width=20, height=2)
        ...
        for i in range(4):
            opcion = pregunta_actual['opciones'][i]
            if isinstance(opcion, str) and opcion.lower().endswith('.png'):
                # Si la opción es una ruta de imagen con extensión .png, cargarla como imagen en el botón.
                imagen_opcion = Image.open(opcion)
                imagen_opcion = imagen_opcion.resize((100, 100))  # Ajusta el tamaño a 100x100.
                imagen_opcion = ImageTk.PhotoImage(imagen_opcion)
                botones_opciones[i].config(text="", image=imagen_opcion, compound="center", width=100, height=100)  # Tamaño fijo de 100x100
                botones_opciones[i].image = imagen_opcion
            else:
                botones_opciones[i].config(text=opcion, width=20, height=2)
