...
preguntas = [
    #GRADO 9°
    {
        'grado': 9,
        'tipo': 'texto',
        'pregunta': 'Sabemos que de 4 corredores de la maratón, C llegó después de B, y el corredor D llegó en medio de los corredores A y C. ¿Cuál fue el orden en el que llegaron los corredores a la meta?',
    ...
    },  
    {
        'grado': 9,
        'tipo': 'texto',
        'pregunta': 'En una fábrica se empacan botellas en cajas de dos tipos, en un tipo caben exactamente 5 botellas y en las del otro tipo caben exactamente 9 botellas. ¿El mínimo número de cajas que se deben usar para empacar totalmente 100 botellas es?',
    ...
    },
    {
        'grado': 9,
        'tipo': 'texto',
        'pregunta': 'En una textilería se tiene un corte de dril de 64 metros, si cada día se venden cuatro metros, entonces el tiempo que tardarán en cortar toda la pieza es:',
    ...
    },  
    {
        'grado': 9,
        'tipo': 'texto',
        'pregunta': 'Decir: "Todos los celulares son rojos", es lo mismo que afirmar:',
    ...
    }, 
    {
        'grado': 9,
        'tipo': 'texto',
        'pregunta': 'Un tren recorrió 240 km a una velocidad de 80 km/h. ¿Cuánto tiempo llevó realizar el viaje?',
    ...
    },
    {
        'grado': 9,
        'tipo': 'texto',
        'pregunta': 'Al curso de razonamiento lógico asisten 45 estudiantes donde hay 10 alumnas que tienen cabello rubio, 20 alumnas que tienen el cabello negro, 5 hombres que tienen cabello rubio y 10 hombres tienen el cabello negro. La probabilidad de que un alumno sea hombre es:',
    ...
    }, 
    {
        ...
        'grado': 9,
        'tipo': 'imagen',
        'pregunta': 'Un trozo de madera ha sido marcado en cuadrados iguales. ¿Cuántos cortes rectos deberán realizarse como mínimo, de modo que todos los cuadrados que contienen las letras estén separados?',
        'imagen': 'PROYECTO-SECRETO/RECURSOS/p5.png',
        'texto_debajo_imagen': '',
        'opciones': ['2 como mínimo', '3 como mínimo', '4 como mínimo', '5 como mínimo'],
        'respuesta_correcta': '3 como mínimo'
    },    
    {
        'grado': 9,
        'tipo': 'imagen',
        'pregunta': '¿Cuántas monedas como mínimo se deben mover, para que la figura (I) se convierta en la figura (II)?',
    ...
    },  
    {
        'grado': 10,
        'tipo': 'texto',
        'pregunta': '¿Cuál de los siguientes números no pertenece a la sucesión? 1, 8, 27, 36, 125, 216',
    ...
    },    
    {
        'grado': 10,
        'tipo': 'texto',
        'pregunta': 'Una máquina tiene 5 bolas rojas, 4 bolas blancas y 5 bolas amarillas. ¿Cuántas monedas de $100 se deben echar en la máquina para que se hayan sacado 2 bolas de igual color, sabiendo que para sacar dos bolas se necesita 1 moneda?',
        'opciones': ['2', '4', '3', '7'],
    ...
    },
    {
        'grado': 10,
        'tipo': 'texto',
        'pregunta': 'En una clase, un profesor pregunta a sus alumnos si entendieron la explicación, a lo cual uno de ellos contesta: "Todos no entendimos", por lo tanto el profesor puede deducir que:',
    ...
    }, 
    {
        'grado': 10,
        'tipo': 'texto',
        'pregunta': 'Una fábrica que trabaja a un ritmo constante produce 20 automóviles en 4 días. ¿Cuántos automóviles son posibles de fabricar en tres fábricas similares, que trabajan al mismo ritmo, en 6 días?',
    ...
    },
    {
        'grado': 10,
        'tipo': 'texto',
        'pregunta': 'Felipe tiene tres docenas y media de canicas; al jugar pierde 18 canicas, y posteriormente le regalan una docena, ¿cuántas le quedaron?',
    ...
    },   
    {
        'grado': 10,
        'tipo': 'texto',
        'pregunta': 'En una caja hay 6 bolas enumeradas del 1 al 6. Se extraen al azar, una tras otra, tres bolas, sin restituir la bola que ha sido extraída, y se registran (de izquierda a derecha) los números de las bolas que van saliendo, según el orden de salida de modo que resulte un número de tres cifras. ¿Cuántos números diferentes de tres cifras pueden obtenerse de este modo?',
    ...
    },
    {
        'grado': 10,
        'tipo': 'texto',
        'pregunta': 'Si arrojamos un dado y luego de ello arrojamos una moneda, ¿cuál será el número de resultados posibles de este experimento?',
        'opciones': ['7', '12', '72', '8'],
        'respuesta_correcta': '12'
    },  
    {
    ...
    },
    {
        'grado': 10,
        'tipo': 'imagen',
        'pregunta': 'En una encuesta aplicada a 40 estudiantes se obtuvieron los siguientes resultados',
    ...
    },#un comentario para no llorar
    {
        'grado': 11,
        'tipo': 'texto',
        'pregunta': '¿Cuál sigue en la sucesión? 22C, 42F, 62I, ... ',
    ...
    },
    {
        'grado': 11,
        'tipo': 'texto',
        'pregunta': 'En el siguiente conjunto de datos: 18, 18, 19, 17, 23, 20, 21, 18. ¿Cuál es la mediana?',
    ...
    },
    {
        'grado': 11,
        'tipo': 'texto',
        'pregunta': 'Si el peso de una persona es de 60 kilogramos más la mitad de su propio peso, entonces la ecuación que relaciona los x kilogramos que pesa la persona son:',
    ...
    },
    {
        'grado': 11,
        'tipo': 'texto',
        'pregunta': 'La fábrica de leche "Luna Azul", aumentó el precio de cada litro un 5%, si el costo anterior era de $4000, ¿Cuál es el precio actual del litro de leche?',
    ...
    },
    {
        'grado': 11,
        'tipo': 'texto',
        'pregunta': 'Un estudiante realiza las operaciones de un problema en su calculadora y redondea el resultado a 48,2. El redondeo lo hizo respecto a las céntimas más próximas. ¿Cuál de los siguientes números es el más aproximado al que obtuvo en la calculadora?',
    ...
    },
    {
        'grado': 11,
        'tipo': 'texto',
        'pregunta': 'Se tienen 4 cajas que contienen tornillos de 10 gramos cada uno y una caja que contiene tornillos de 11 gramos cada uno. ¿Cuántas veces se debe pesar como mínimo en una balanza de 2 platillos para determinar la caja que contiene los tornillos de mayor peso?',
        'opciones': ['1', '2', '3', '4'],
        'respuesta_correcta': '3'
    },
    {
    ...
    # RONDA FINAL
    {
        'grado': 1,
        'tipo': 'texto',
        'pregunta': 'Carlos y Roció deciden verse a las 8 p.m. Carlos tiene un reloj 15 minutos adelantado y Roció 15 minutos atrasado. Si Carlos llega a la cita 15 minutos antes según su reloj, y Roció llega 15 minutos retrasada según su reloj. ¿Cuánto tiempo esperó Carlos?',
    ...
    }, 
    {
        'grado': 1,
        'tipo': 'texto',
        'pregunta': '2 personas pintan una casa en 36 horas, si esta labor la realizan 6 personas ¿En cuánto tiempo la pintarían?',
    ...
    {  
        'grado': 1,
        'tipo': 'texto',
        'pregunta': 'En una caja hay 20 sombreros blancos y 13 sombreros negros. Jorge extrajo al azar de la caja 3 sombreros uno tras otro sin restituirlos, y los 3 sombreros extraídos resultaron negros. ¿Cuál es la probabilidad de que el cuarto sombrero extraído al azar sea también negro?',
    ...
    },
    {
        'grado': 1,
        'tipo': 'texto',
        'pregunta': 'Decir: "Existe un número primo par" es lo mismo que afirmar:',
    ...
    },
    {
        'grado': 1,
        'tipo': 'texto',
        'pregunta': 'AMERICA = 1734651, INDIA = 68961, ¿CANADA =?, ¿Cómo se escribiría Canadá de acuerdo con las representaciones?',
    ...
    },
    {
        ...
        'texto_debajo_imagen': '',
        'opciones': ['9 kg', '10 kg', '11 kg', '12 kg'],
        'respuesta_correcta': '12 kg'
    },   
    {
        'grado': 1,
        'tipo': 'imagen',
        'pregunta': 'De las figuras 1, 2, 3, 4, 5 y 6, la que representa la vista lateral izquierda de la figura inicial es:',
...
def abrir_ventana_juego(grado):
    ...
    def terminar_juego():
        ...
        ventana_juego.after(2000, ventana_juego.destroy)
...
oli_titulo = tk.Label(ventana_inicio, text='OLIMPIADAS DE MATEMATICAS 2023', bg='azure', fg="black", pady=20, font=('Broadway', 40))
oli_titulo.pack(pady=10)

etiqueta_grado = tk.Label(ventana_inicio, text='Selecciona el grado:', bg='azure', fg="black", pady=20, font=('Broadway', 40))
...
boton_final = tk.Button(ventana_inicio, text="FINAL", bg="lightgoldenrod1", fg="black", font=('Broadway', 20), width=18, height=2, command=lambda: abrir_ventana_juego(1))
